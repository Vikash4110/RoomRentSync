    ...
    >
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          ...
          <motion.div className="space-y-6" variants={sectionVariants}>
            ...
            <motion.p
              ...
              variants={sectionVariants}
            >
              Your all-in-one solution for finding compatible roommates and perfect rentals with trusted dealers.
            </motion.p>
          ...
          <motion.div variants={sectionVariants}>
            ...
            <motion.ul className="mt-6 space-y-4" variants={containerVariants}>
              {["About Us", "Roommates", "Rentals", "Dealers"].map((item, index) => (
                <motion.li
                  key={index}
                  variants={listItemVariants}
                  whileHover={{ x: 5 }}
        ...
        <motion.p
          ...
          variants={sectionVariants}
        >
          ©️ {new Date().getFullYear()}, All Rights Reserved by RoommateFinder
        </motion.p>
      </div>
    </motion.section>
  );
